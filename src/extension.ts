...
class DevAlertExt {
    ...
    constructor() {
        this._onOpenTextDocument = vscode.workspace.onDidOpenTextDocument((e: any) => this.showMessages([e]));
        this._onCloseTextDocument = vscode.workspace.onDidCloseTextDocument((e: any) => this.OnCloseTextDocument(e));
    ...
    private showMessages(docs: vscode.TextDocument[]) {
        ...
        if ((Object.keys(this._editMessages).length > 0 || Object.keys(this._editAlwaysMessages).length) > 0 && this._onTextDocumentChanged.length == 0) {
            this._onTextDocumentChanged.push(vscode.workspace.onDidChangeTextDocument((e: any) => this.documentChanged(e)));
        }
    }
...
export function activate(context: vscode.ExtensionContext) {
    context.subscriptions.push(new DevAlertExt());
}
